...
<body>
	<div class="main-contents">
		...
		<form action="setting" method="post">
			...
			<input name="userLoginid" value="${editUser.loginId}"
				id="userLoginid" type="hidden" /> <label for="password">パスワード</label>
			<input name="password" type="password" id="password" /><br /> <label
				for="check">パスワード（確認用）</label> <input name="check" type="password"
				id="check" /><br /> <label for="name">名称</label> <input
				name="name" value="${editUser.name}" id="name" /><br /> <label
				for="branches">支店</label> <select name="branchId" id="branchId"
				size="1">
			...
			</select><br /> <label for="positions">部署・役職</label> <select
				name="positionId" id="positionId" size="1">
			...
			</select><br /> <input type="submit" value="編集" /><br /> <a href="./">戻る</a>
		</form>
